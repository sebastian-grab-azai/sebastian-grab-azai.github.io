  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section id="purpose" className="py-16 lg:py-20 bg-white">
          <div className="container mx-auto px-4 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 max-w-8xl mx-auto">
            ...
            <Card className="bg-[#FFFFFF] border-0 ring-1 ring-black/5 shadow-xl rounded-3xl">
              <CardContent className="p-8 lg:p-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-foreground/80 text-center max-w-xl mx-auto">
            ...
            <Card className="bg-[#FFFFFF] border-0 ring-1 ring-black/5 shadow-xl rounded-3xl">
              <CardContent className="p-8 lg:p-10">
                ...
                <ul className="list-disc list-inside space-y-2 text-foreground/85 text-center max-w-xl mx-auto">
              ...
              <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-start lg:divide-x lg:divide-white/10">
                ...
                <div className="lg:pr-12 lg:col-span-3">
                  ...
                  {L.earlyAccess.footnote ? (
                    <p className="mt-4 text-xs text-white/60">{L.earlyAccess.footnote}</p>
                  ) : null}
                </div>
